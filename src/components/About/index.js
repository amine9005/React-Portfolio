    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p className="second">
            I'm a <strong>confident</strong> person who attempts to take on hard{' '}
            <strong>challenges</strong> and solve problems that have not yet
            been <strong>solved</strong> I enjoy helping people and I aim to
            create long <strong>lasting</strong> relationships and to{' '}
            <strong>provide</strong> value to other people
          </p>
          <p className="third">
            Thank you for taking the time learn about me{' '}
            <strong>you are appreciated</strong>
          </p>
